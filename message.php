...
switch ($method) {
    case "GET":
        ...
        if (isset($_GET['sender_id'])) {
            ...
            $sql = "SELECT profile.profile, message.message_id, message.sender_id, message.receiver_id, message.message_context, message.created_at, profile.fullname AS sender_username
            FROM message 
            LEFT JOIN profile ON profile.credential_id = message.sender_id
            WHERE (message.sender_id = :sender_id OR message.receiver_id = :sender_id)
